					...
					<View className="service-wrap__view__content">
						...
						<View className="service-wrap__view__link" >
							...
							<View className="service-wrap__view__link__content">
								<Text className="service-wrap__view__link__content__text" >155 8167 5020</Text>
								<View className="service-wrap__view__link__content__btn" onClick={this.handlePhoneCall.bind(this, '15581675020')}>
						...
						<View className="service-wrap__view__link" >
							...
							<View className="service-wrap__view__link__content">
								<Text className="service-wrap__view__link__content__text" >155 8167 5020</Text>
								<View className="service-wrap__view__link__content__btn" onClick={this.onCopy.bind(this, '15581675020')}>
						...
						<View  className="service-wrap__view__mini">
							...
							<Image className="service-wrap__view__mini__img" src={STATIC_ASSETS('images/service_code.jpg')} />
