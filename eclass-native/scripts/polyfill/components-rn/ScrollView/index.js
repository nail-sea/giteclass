...
class _ScrollView extends React.Component {
    ...
    render() {
        ...
        const wrapperStyle = omit(flattenStyle, [
            'alignItems',
            'justifyContent'
        ]);
        ...
        return data && renderItem ? (React.createElement(FlatList, Object.assign({}, scrollElementProps, { data: data, renderItem: renderItem, keyExtractor: (item, index) => index + '' }))) : (React.createElement(ScrollView, Object.assign({}, scrollElementProps), children));
    }
}
